...
2. **Create a branch** for your feature: `git checkout -b feature/smarter-router`
3. **Make your changes** and write clear commit messages
4. **Test** your changes end-to-end with at least one vectorstore query and one web search query
